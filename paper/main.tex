...
\title{Foundations of the A=1 Discrete Causal Lattice:\\
       Bipartite Octahedral Lattices in Arbitrary Dimension%
...
%% ============================================================
%% PART I: COMBINATORIAL FOUNDATIONS
%% ============================================================
\section{Introduction}
\input{sections/introduction}

\section{The General Bipartite Octahedral Lattice in Dimension $n$}
\input{sections/lattice_n_dim}

\section{Automorphism Algebra in Dimension $n$}
\input{sections/automorphism_algebra}

%% ============================================================
%% PART II: ANALYTIC FOUNDATIONS
%% ============================================================
\section{Discrete Differential Geometry on the Lattice}
\input{sections/discrete_diff_geometry}

\section{Function Spaces on the Lattice}
\input{sections/function_spaces}

\section{Discrete Measure Theory on the Lattice}
\input{sections/discrete_measure_theory}

%% ============================================================
%% PART III: THE HILBERT-SIXTH ON-RAMP
%% ============================================================
\section{Discrete-to-Continuum Limit Operators}
\input{sections/continuum_limits}

%% ============================================================
%% PART IV: MOTIVATING EXAMPLES (FRAMING ONLY)
%% ============================================================
\section{Motivating Examples: Boltzmann and the Fluid Limit}
\input{sections/motivating_examples}
